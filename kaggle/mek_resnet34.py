"""
MEK + ResNet-34 — single-file Kaggle script (FER-2013 | RAF-DB).
...
if DATASET == "fer2013":
    ...
    BATCH_SIZE         = 64
    EPOCHS             = 80
    LR                 = 1e-4         # validation-tuned best (FER MEK-RN34)
    LABEL_SMOOTH       = 0.1          # ε
    FLIP_LOSS_WEIGHT   = 0.1          # λ — FER wants a much lighter AC weight than RAF-DB
    ROTATION_DEG       = 10
    COLOR_JITTER       = 0.2
    ...
    BATCH_SIZE         = 64
    EPOCHS             = 60
    LR                 = 2e-4         # validation-tuned best (RAF-DB MEK-RN34 wants lower LR than RN18)
    LABEL_SMOOTH       = 0.2          # ε — stronger re-balance lifts fear/disgust above RN18
